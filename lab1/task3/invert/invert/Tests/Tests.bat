...
%MyProgram% matrix2x2.txt > %OUT% && goto err
echo test 3 has passed

%MyProgram% matrix4x5.txt > %OUT% && goto err
...
%MyProgram% matrixNotNumber.txt > %OUT% && goto err
echo test 8 has passed

%MyProgram% matrix2.txt matrix3.txt > %OUT% && goto err
